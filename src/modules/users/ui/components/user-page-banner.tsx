    ...
    <div className="relative group">
      ...
      >
        {user.clerkId === userId && (
          <Button
            type="button"
            className="absolute top-4 right-4 rounded-full bg-black/20 hover:bg-black/50 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            size={"icon"}
